...
HIT_URL = "https://julia-ridley.github.io/Testing/"  # Provide the URL that you want workers to sent sent to complete you task
...
TITLE = 'Counting People in Photographs'
# Description of the HIT that workers will see when deciding to accept it or not
DESCRIPTION = "YCount the people by clicking on their face"
# Search terms for the HIT posting
KEYWORDS = ['example', 'test', 'Mechanical Turk']


# Your Amazon Web Services Access Key (private)
AWS_ACCESS_KEY = 'AKIAJGFHN4XD7RYO6V6A' # Enter your access key here
# Your Amazon Web Services Secret Key (private)
AWS_SECRET_KEY = '9AvCXZPK2ILLH2aMVUD4JwOX+JYDPLtE5qUjh/3/' # Enter your private key here
